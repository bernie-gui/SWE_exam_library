...
int main() {
    ...
    lambda_parser_t parsy("examples/example_07_25_2.txt", {
        ...
        {"B", [gl](auto &iss) { double temp; iss >> temp; gl->set_optimizer_budget(temp); }},
    ...
    std::cout << "A " << gl->get_optimizer_optimal_parameters()[0] << std::endl
            << "C " << gl->get_optimizer_result() << std::endl;
}